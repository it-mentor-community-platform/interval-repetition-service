...
public interface SelectedCategoryMapper {
    ...
    List<SavedSelectedCategoryResponseDto> toSavedSelectedCategoryResponseList(List<CategoryWithSpecializationName> categories);


    @Mapping(target = "specialization", source = "category.specializationName")
    SelectedCategoryResponseDto toSelectedCategoryResponse(CategoryWithStatistics category);

    List<SelectedCategoryResponseDto> toSelectedCategoryResponseList(List<CategoryWithStatistics> categories);
